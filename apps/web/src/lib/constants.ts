...
export const DESIGNER_STAGES = [
  ...
  { id: 'queryTransform', label: 'Query processing', path: '/designer/query-transform' },
  { id: 'retrieval',  label: 'Retrieval',          path: '/designer/retrieval' },
  { id: 'contextCompression', label: 'Context compression', path: '/designer/context-compression' },
  ...
  { id: 'observability', label: 'Observability & tools', path: '/designer/observability' },
