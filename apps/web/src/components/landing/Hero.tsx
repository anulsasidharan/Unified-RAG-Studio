    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-primary-50 via-white to-purple-50">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-24 pt-20 sm:px-6 sm:pb-32 sm:pt-28 lg:px-8">
        ...
        <div className="mb-8 flex justify-center lg:justify-start">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary-200 bg-white/80 px-4 py-2 text-sm font-medium text-primary-700 shadow-sm backdrop-blur-sm">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-14 lg:text-left">
          <div className="text-center lg:text-left">
            ...
            {/* Sub-headline */}
            <p className="mx-auto mb-8 max-w-xl text-xl leading-relaxed text-neutral-600 sm:text-2xl lg:mx-0">
