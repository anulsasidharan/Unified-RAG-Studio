...
function StageConfiguratorSkeleton() {
  return <div className="bg-muted/40 mt-8 h-40 animate-pulse rounded-lg" aria-hidden />;
}

function lazyConfigurator(loader: () => Promise<{ default: ComponentType<ConfiguratorProps> }>) {
